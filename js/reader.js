...
if (main) {
  ...
  // (reading-position resume is handled by the global sd-last-read resume-toast
  //  elsewhere in this file — the earlier sd-pos- resume-chip was redundant and removed)
}
